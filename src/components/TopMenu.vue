      ...
      <el-row>
        ...
        <el-col :span="4"
          ...
          <el-autocomplete v-model="state"
                           ...
                           placeholder="请输入内容"
                           @select="handleSelect"><i style="color:#969696;position: relative;top: 5px;font-size: 19px;"
        ...
        <el-col :span="7"
          ...
          <!-- <el-col :span="1"> -->
          <el-button type='text'
                     style="color:#303133;font-weight:400;">登录</el-button>
          <!-- </el-col> -->
          <!-- <el-col :span="1"> -->
          <el-button type='text'
                     style="color:#303133;font-weight:400;">注册</el-button>
          <!-- </el-col>
          <el-col :span="1"> -->
